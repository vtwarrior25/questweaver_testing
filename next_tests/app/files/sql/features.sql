...
('Bard Spellcasting', 'Spellcasting', '', 'None'),
...
('Cleric Spellcasting', 'Spellcasting', '', 'None'),
...
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Fighting Style'), 2),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Spellcasting'), 2),
...
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Ability Score Improvement'), 4);
