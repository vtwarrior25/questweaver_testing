...
('Barbarian Extra Attack', 'Extra Attack', 'Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.', 'None'),
...
('Bardic Inspiration', 'Bardic Inspiration', 'You can inspire others through stirring words or music. To do so, you use a bonus action on your turn to choose one creature other than yourself within 60 feet of you who can hear you. That creature gains one Bardic Inspiration die, a d6. ;;Once within the next 10 minutes, the creature can roll the die and add the number rolled to one ability check, attack roll, or saving throw it makes. The creature can wait until after it rolls the d20 before deciding to use the Bardic Inspiration die, but must decide before the GM says whether the roll succeeds or fails. Once the Bardic Inspiration die is rolled, it is lost. A creature can have only one Bardic Inspiration die at a time. ;;You can use this feature a number of times equal to your Charisma modifier (a minimum of once). You regain any expended uses when you finish a long rest. ;;Your Bardic Inspiration die changes when you reach certain levels in this class. The die becomes a d8 at 5th level, a d10 at 10th level, and a d12 at 15th level.', 'None'),
...
('Bard Expertise', 'Expertise', 'At 3rd level, choose two of your skill proficiencies. Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies. ;;At 10th level, you can choose another two skill proficiencies to gain this benefit. ', 'None'),
...
('Cleric Spellcasting', 'Spellcasting', 'As a conduit for divine power, you can cast cleric spells.;;Cantrips;;At 1st level, you know three cantrips of your choice from the cleric spell list. You learn additional cleric cantrips of your choice at higher levels, as shown in the Cantrips Known column of the Cleric table.;;Preparing and Casting Spells;;The Cleric table shows how many spell slots you have to cast your spells of 1st level and higher. To cast one of these spells, you must expend a slot of the spell''s level or higher. You regain all expended spell slots when you finish a long rest;;You prepare the list of cleric spells that are available for you to cast, choosing from the cleric spell list. When you do so, choose a number of cleric spells equal to your Wisdom modifier + your cleric level (minimum of one spell). The spells must be of a level for which you have spell slots.;;For example, if you are a 3rd-level cleric, you have four 1st-level and two 2nd-level spell slots. With a Wisdom of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination. If you prepare the 1st-level spell cure wounds, you can cast it using a 1st-level or 2nd-level slot. Casting the spell doesn''t remove it from your list of prepared spells.;;You can change your list of prepared spells when you finish a long rest. Preparing a new list of cleric spells requires time spent in prayer and meditation: at least 1 minute per spell level for each spell on your list.;;Spellcasting Ability;;Wisdom is your spellcasting ability for your cleric spells. The power of your spells comes from your devotion to your deity. You use your Wisdom whenever a cleric spell refers to your spellcasting ability. In addition, you use your Wisdom modifier when setting the saving throw DC for a cleric spell you cast and when making an attack roll with one.;;Spell save DC = 8 + your proficiency bonus + your Wisdom modifier;;Spell attack modifier = your proficiency bonus + your Wisdom modifier;;Ritual Casting;;You can cast a cleric spell as a ritual if that spell has the ritual tag and you have the spell prepared.;;Spellcasting Focus;;You can use a holy symbol (see chapter 5, “Equipment”) as a spellcasting focus for your cleric spells. ', 'None'),
...
('Fighter Fighing Style', 'Fighting Style', 'Archery;; You gain a +2 bonus to attack rolls you make with ranged weapons.;;Defense;;While you are wearing armor, you gain a +1 bonus to AC.;;Dueling;;When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon.;;Great Weapon Fighting;;When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed or versatile property for you to gain this benefit.;;Protection;;When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield.;;Two-Weapon Fighting;;When you engage in two-weapon fighting, you can add your ability modifier to the damage of the second attack.', 'None'),
...
('Fighter Ability Score Improvement', 'Ability Score Improvement', 'When you reach 4th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can''t increase an ability score above 20 using this feature.', 'Ability Score'),
('Fighter Extra Attack', 'Extra Attack', 'Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.', 'None'),
...
('Monastic Tradition', 'Monastic Tradition', 'When you reach 3rd level, you commit yourself to a monastic tradition: the Way of the Open Hand, the Way of Shadow, or the Way of the Four Elements, all detailed at the end of the class description. Your tradition grants you features at 3rd level and again at 6th, 11th, and 17th level.', 'None'),
('Deflect Missiles', 'Deflect Missiles', 'Starting at 3rd level, you can use your reaction to deflect or catch the missile when you are hit by a ranged weapon attack. When you do so, the damage you take from the attack is reduced by 1d10 + your Dexterity modifier + your monk level. If you reduce the damage to 0, you can catch the missile if it is small enough for you to hold in one hand and you have at least one hand free. If you catch a missile in this way, you can spend 1 ki point to make a ranged attack with the weapon or piece of ammunition you just caught, as part of the same reaction. You make this attack with proficiency, regardless of your weapon proficiencies, and the missile counts as a monk weapon for the attack, which has a normal range of 20 feet and a long range of 60 feet.', 'None'),
...
('Monk Extra Attack', 'Extra Attack', 'Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn.', 'None'),
...
-- Paladin
('Paladin Proficiencies', 'Proficiencies', 'Armor: All armor, shields ;;Weapons: Simple weapons, martial weapons ;;Tools: None ;;Saving Throws: Wisdom, Charisma ;;Skills: Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion', 'Proficiency'),
('Divine Sense', 'Divine Sense', 'The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). ;;Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the hallow spell. ;;You can use this feature a number of times equal to 1 + your Charisma modifier. When you finish a long rest, you regain all expended uses. ', 'Ability Action'),
('Lay on Hands', 'Lay on Hands', 'Your blessed touch can heal wounds. You have a pool of healing power that replenishes when you take a long rest. With that pool, you can restore a total number of hit points equal to your paladin level × 5. ;;As an action, you can touch a creature and draw power from the pool to restore a number of hit points to that creature, up to the maximum amount remaining in your pool. ;;Alternatively, you can expend 5 hit points from your pool of healing to cure the target of one disease or neutralize one poison affecting it. You can cure multiple diseases and neutralize multiple poisons with a single use of Lay on Hands, expending hit points separately for each one. ;;This feature has no effect on undead and constructs. ', 'None'),
('Paladin Fighting Style', 'Fighting Style', 'At 2nd level, you adopt a style of fighting as your specialty. Choose one of the following options. You can''t take a Fighting Style option more than once, even if you later get to choose again. ;;Defense ;;While you are wearing armor, you gain a +1 bonus to AC. ;;Dueling ;;When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon. ;;Great Weapon Fighting ;;When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll. The weapon must have the two-handed or versatile property for you to gain this benefit. ;;Protection ;;When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield. ', 'None'),
('Paladin Spellcasting', 'Spellcasting', 'By 2nd level, you have learned to draw on divine magic through meditation and prayer to cast spells as a cleric does. ;;Preparing and Casting Spells ;;The Paladin table shows how many spell slots you have to cast your spells. To cast one of your paladin spells of 1st level or higher, you must expend a slot of the spell''s level or higher. You regain all expended spell slots when you finish a long rest. ;;You prepare the list of paladin spells that are available for you to cast, choosing from the paladin spell list. When you do so, choose a number of paladin spells equal to your Charisma modifier + half your paladin level, rounded down (minimum of one spell). The spells must be of a level for which you have spell slots. ;;For example, if you are a 5th-level paladin, you have four 1st-level and two 2nd-level spell slots. With a Charisma of 14, your list of prepared spells can include four spells of 1st or 2nd level, in any combination. If you prepare the 1st-level spell cure wounds, you can cast it using a 1st-level or a 2nd- level slot. Casting the spell doesn''t remove it from your list of prepared spells. ;;You can change your list of prepared spells when you finish a long rest. Preparing a new list of paladin spells requires time spent in prayer and meditation: at least 1 minute per spell level for each spell on your list. ;;Spellcasting Ability ;;Charisma is your spellcasting ability for your paladin spells, since their power derives from the strength of your convictions. You use your Charisma whenever a spell refers to your spellcasting ability. In addition, you use your Charisma modifier when setting the saving throw DC for a paladin spell you cast and when making an attack roll with one. ;;Spell save DC = 8 + your proficiency bonus + your Charisma modifier ;;Spell attack modifier = your proficiency bonus + your Charisma modifier ;;Spellcasting Focus ;;You can use a holy symbol as a spellcasting focus for your paladin spells. ', 'None'),
('Divine Smite', 'Divine Smite', 'Starting at 2nd level, when you hit a creature with a melee weapon attack, you can expend one spell slot to deal radiant damage to the target, in addition to the weapon''s damage. The extra damage is 2d8 for a 1st-level spell slot, plus 1d8 for each spell level higher than 1st, to a maximum of 5d8. The damage increases by 1d8 if the target is an undead or a fiend.', 'None'),
('Divine Health', 'Divine Health', 'By 3rd level, the divine magic flowing through you makes you immune to disease. ', 'None'),
('Sacred Oath', 'Sacred Oath', 'Sacred Oath ;;When you reach 3rd level, you swear the oath that binds you as a paladin forever. Up to this time you have been in a preparatory stage, committed to the path but not yet sworn to it. Now you choose the Oath of Devotion, the Oath of the Ancients, or the Oath of Vengeance, all detailed at the end of the class description.;; Your choice grants you features at 3rd level and again at 7th, 15th, and 20th level. Those features include oath spells and the Channel Divinity feature. ;;Oath Spells ;;Each oath has a list of associated spells. You gain access to these spells at the levels specified in the oath description. Once you gain access to an oath spell, you always have it prepared. Oath spells don''t count against the number of spells you can prepare each day. ;;If you gain an oath spell that doesn''t appear on the paladin spell list, the spell is nonetheless a paladin spell for you. ;;Channel Divinity ;;Your oath allows you to channel divine energy to fuel magical effects. Each Channel Divinity option provided by your oath explains how to use it. ;;When you use your Channel Divinity, you choose which option to use. You must then finish a short or long rest to use your Channel Divinity again. ;;Some Channel Divinity effects require saving throws. When you use such an effect from this class, the DC equals your paladin spell save DC.', 'None'),
('Paladin Ability Score Improvement', 'Ability Score Improvement', 'When you reach 4th level, and again at 8th, 12th, 16th, and 19th level, you can increase one ability score of your choice by 2, or you can increase two ability scores of your choice by 1. As normal, you can''t increase an ability score above 20 using this feature. ', 'None'),
('Paladin Extra Attack', 'Extra Attack', 'Beginning at 5th level, you can attack twice, instead of once, whenever you take the Attack action on your turn. ', 'None'),
('Tenets of Devotion', 'Tenets of Devotion', 'Though the exact words and strictures of the Oath of Devotion vary, paladins of this oath share these tenets. ;;Honesty. Don''t lie or cheat. Let your word be your promise. ;;Courage. Never fear to act, though caution is wise. ;;Compassion. Aid others, protect the weak, and punish those who threaten them. Show mercy to your foes, but temper it with wisdom. ;;Honor. Treat others with fairness, and let your honorable deeds be an example to them. Do as much good as possible while causing the least amount of harm. ;;Duty. Be responsible for your actions and their consequences, protect those entrusted to your care, and obey those who have just authority over you. ', 'None'),
('Oath Of Devotion Spells', 'Oath Spells', 'You gain oath spells at the paladin levels listed: ;;3rd: protection from evil and good, sanctuary;; 5th: lesser restoration, zone of truth;; 9th: beacon of hope, dispel magic;; 13th: freedom of movement, guardian of faith;; 17th: commune, flame strike', 'None'),
('Oath Of Devotion Channel Divinity', 'Channel Divinity', 'When you take this oath at 3rd level, you gain the following two Channel Divinity options. ;;Sacred Weapon;; As an action, you can imbue one weapon that you are holding with positive energy, using your Channel Divinity. For 1 minute, you add your Charisma modifier to attack rolls made with that weapon (with a minimum bonus of +1). The weapon also emits bright light in a 20-foot radius and dim light 20 feet beyond that. If the weapon is not already magical, it becomes magical for the duration. ;;You can end this effect on your turn as part of any other action. If you are no longer holding or carrying this weapon, or if you fall unconscious, this effect ends. ;;Turn the Unholy;; As an action, you present your holy symbol and speak a prayer censuring fiends and undead, using your Channel Divinity. Each fiend or undead that can see or hear you within 30 feet of you must make a Wisdom saving throw. If the creature fails its saving throw, it is turned for 1 minute or until it takes damage. ;;A turned creature must spend its turns trying to move as far away from you as it can, and it can''t willingly move to a space within 30 feet of you. It also can''t take reactions. For its action, it can use only the Dash action or try to escape from an effect that prevents it from moving. If there''s nowhere to move, the creature can use the Dodge action. ', 'None');
-- Ranger
...
((SELECT featureid FROM feature WHERE name = 'Divine Sense'), (SELECT abilityid FROM ability WHERE abbrev = 'Cha'), 1);
...
--Monk--
((SELECT featureid FROM feature WHERE name = 'Monk Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Simple Weapons')),
((SELECT featureid FROM feature WHERE name = 'Monk Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Shortsword')),
((SELECT featureid FROM feature WHERE name = 'Monk Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Strength')),
((SELECT featureid FROM feature WHERE name = 'Monk Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Dexterity')),
-- Druid
...
((SELECT featureid FROM feature WHERE name = 'Warlock Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Simple Weapons')),
...
-- Paladin
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Light Armor')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Medium Armor')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Heavy Armor')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Shields')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Simple Weapons')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Martial Weapons')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Wisdom')),
((SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), (SELECT proficiencyid FROM proficiency WHERE name = 'Charisma'));
...
((SELECT classid FROM class WHERE name = 'Barbarian'), (SELECT featureid FROM feature WHERE name = 'Barbarian Extra Attack'), 5),
...
((SELECT classid FROM class WHERE name = 'Bard'), (SELECT featureid FROM feature WHERE name = 'Bard Spellcasting'), 1),
...
((SELECT classid FROM class WHERE name = 'Fighter'), (SELECT featureid FROM feature WHERE name = 'Fighter Extra Attack'), 5),
--Monk--
...
((SELECT classid FROM class WHERE name = 'Monk'), (SELECT featureid FROM feature WHERE name = 'Monastic Tradition'), 3),
((SELECT classid FROM class WHERE name = 'Monk'), (SELECT featureid FROM feature WHERE name = 'Deflect Missiles'), 3),
...
((SELECT classid FROM class WHERE name = 'Monk'), (SELECT featureid FROM feature WHERE name = 'Monk Extra Attack'), 5),
...
((SELECT classid FROM class WHERE name = 'Warlock'), (SELECT featureid FROM feature WHERE name = 'Otherworldly Patron'), 1),
((SELECT classid FROM class WHERE name = 'Warlock'), (SELECT featureid FROM feature WHERE name = 'Pact Magic'), 1),
((SELECT classid FROM class WHERE name = 'Warlock'), (SELECT featureid FROM feature WHERE name = 'Eldritch Invocations'), 2),
((SELECT classid FROM class WHERE name = 'Warlock'), (SELECT featureid FROM feature WHERE name = 'Pact Boon'), 3),
((SELECT classid FROM class WHERE name = 'Warlock'), (SELECT featureid FROM feature WHERE name = 'Warlock Ability Score Improvement'), 4),
-- Paladin
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Paladin Proficiencies'), 1),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Divine Sense'), 1),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Lay on Hands'), 1),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Paladin Fighting Style'), 2),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Paladin Spellcasting'), 2),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Divine Smite'), 2),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Divine Health'), 3),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Sacred Oath'), 3),
((SELECT classid FROM class WHERE name = 'Paladin'), (SELECT featureid FROM feature WHERE name = 'Paladin Ability Score Improvement'), 4);
...
((SELECT subclassid FROM subclass WHERE name = 'The Fiend'), (SELECT featureid FROM feature WHERE name = 'Fiend Expanded Spell List'), 2),
((SELECT subclassid FROM subclass WHERE name = 'The Fiend'), (SELECT featureid FROM feature WHERE name = 'Dark One''s Blessing'), 2),
((SELECT subclassid FROM subclass WHERE name = 'Oath of Devotion'), (SELECT featureid FROM feature WHERE name = 'Tenets of Devotion'), 3),
((SELECT subclassid FROM subclass WHERE name = 'Oath of Devotion'), (SELECT featureid FROM feature WHERE name = 'Oath Of Devotion Spells'), 3),
((SELECT subclassid FROM subclass WHERE name = 'Oath of Devotion'), (SELECT featureid FROM feature WHERE name = 'Oath Of Devotion Channel Divinity'), 3);
